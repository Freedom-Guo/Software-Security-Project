...
int main(int argc, const char * argv[])
{
    ...
    pf3=fopen(file_name_in_2,"r");
    printf("请输入文件2名：\n");
    scanf("%s",file_name_out_2);
    pf4=fopen(file_name_out_2,"w");
    Pre_deal(pf3,pf4,file_name_in_2,file_name_out_2);
    fclose(pf3);
    fclose(pf4);
    pf4=fopen(file_name_out_2,"r");
    //生成文件的函数体链表
    tree_1=Tree_create(pf2);
    Show(tree_1);
